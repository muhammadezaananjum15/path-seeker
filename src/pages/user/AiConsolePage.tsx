          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600">
                A calm, dedicated strategy console to evaluate major career decisions, pivots, and skill roadmaps.
              </p>
            </div>
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200 shadow-xl space-y-6 min-h-[500px] flex flex-col justify-between">
          ...
          >
            ...
            <button
              ...
              className="px-7 py-4 rounded-full bg-[#4F20C9] hover:bg-purple-700 text-white font-bold text-sm shadow-lg flex items-center gap-2 disabled:opacity-40 uppercase tracking-wider"
            >
              <span>Send</span>
